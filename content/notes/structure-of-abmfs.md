...
lastEditedTime: "2026-06-16T08:31:00.000Z"
category: "quant"
tags: []
status: "Published"
...
```mermaid
flowchart TD
    U\["用户 / Agent<br/\>提出单因子想法"\] \-\-\> R\["单因子研究<br/\>factor\_research\_job / orchestrator"\]
    ...
    ETL \-\-\> MARKET
    MARKET \-\-\> V\["因子日更FactorManager<br/\>factor\_daily\_job"\]

    C \-\-\> V
    A \-\-\> V
    V \-\-\> FACTORDB
    V \-\-\> E\["因子评价FactorEvalService <br/\> factor\_eval\_timeseries <br/\>factor\_rolling\_metrics"\]
